<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.kh.mypage.model.vo.Point, com.kh.mypage.model.vo.Review, java.util.ArrayList, com.kh.common.model.vo.PageInfo"%>
<%
        ...
        <div id="content_2">
            ...
            <div class="container">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td colspan="4" >
                            ...
                            <br>
                            <div id="qna_txt">
                                <p align="center">작성한 리뷰 내역이 없습니다.</p>
                            </div>
                        </td>
                    </tr>
					<% }else{ %>
                ...
                <div class="paging-area" align="center">
                	<% if(currentPage != 1) {%>
                    	<button class="btn" onclick="location.href='<%=contextPath%>/rafter.mp?cpage=<%=currentPage-1%>'">&lt;</button>
                    <% }else { %>
                    ...
                    <% for(int p=startPage; p<=endPage; p++) { %>
                    	...
                    	<% }else { %>
                    		<button class="btn" onclick="location.href='<%=contextPath %>/rafter.mp?cpage=<%=p%>'"><%=p %></button>
                    	<% } %>
                    <% } %>
