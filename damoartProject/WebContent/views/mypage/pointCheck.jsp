<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.kh.mypage.model.vo.Point, java.util.ArrayList, com.kh.common.model.vo.PageInfo" %>
<%
        ...
        <div id="content_1">
            ...
            <ul>  	
                ...
                <div>
                    ...
                    <a href="<%=contextPath%>/pointList.mp?cpage=1" id="submenu" style="color:rgb(151, 138, 116)">적립금 내역</a> <br>
                </div><br>
                <li><h3>마이활동</h3></li>
                <div>
        ...
        <div id="content_2">
            ...
            <div class="container">
                ...
                <div class="paging-area" align="center">
                	<% if(currentPage != 1) {%>
                    	<button class="btn" onclick="location.href='<%=contextPath%>/pointList.mp?cpage=<%=currentPage-1%>'">&lt;</button>
                    <% }else { %>
                    ...
                    <% for(int p=startPage; p<=endPage; p++) { %>
                    	...
                    	<% }else { %>
                    		<button class="btn" onclick="location.href='<%=contextPath %>/pointList.mp?cpage=<%=p%>'"><%=p %></button>
                    	<% } %>
                    <% } %>
