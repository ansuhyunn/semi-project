...
<body>
    <div class="outer">
        <br>
        <h2 align="center" style="font-weight:bold;">약관동의</h2> <br>
        ...
        <div class="enrollAgreeForm">
            <div id="enroll-agree">
              ...
              <form action="" name="fregister" id="fregister" onsubmit="return fregister_submit(this);" method="" autocomplete="off">
                ...
                <div id="fregister_term">
                    ...
                    <textarea readonly="" cols="75" rows="8" style="resize:none;">제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
                  ...
                  <div id="fregister_private">
                    <fieldset class="fregister_agree2 checks2">            
                        ...
                        <label for="agree21">개인정보 수집 및 이용 동의 <span style="color:red;">(필수)</span></label>
                    </fieldset>
            
                  <textarea readonly="" cols="75" rows="8" style="resize:none;">개인정보처리방침
