...
/**
 * Servlet implementation class AdminNoticeSearchResultController
 */
@WebServlet("/adminSearch.no")
public class AdminNoticeSearchResultController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminNoticeSearchResultController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new NoticeService().adminSelectSearchListCount(keyword);
		...
		ArrayList<Notice> searchList = new NoticeService().adminSelectSearchList(pi, keyword);
		
		request.setAttribute("pi", pi);	
		request.setAttribute("searchList", searchList);
		request.getRequestDispatcher("views/cscenter/admin/adminNoticeSearchResultView.jsp").forward(request, response);
	}
